...
async function getSelectContent() {
  ...
  console.log(inputFirst, inputSencond, selectText);
  console.log(textTitle);
  if (textTitle.indexOf("车辆") !== -1 || textTitle == "") {
    emits("getInputText", inputFirst, inputSencond, selectText);
  } else {
    ...
    <div style="margin-top: 32px; display: flex" v-if="textTitle.indexOf('导出') === -1">
      ...
      <div
        style="
          ...
          align-items: center;
        "
        v-if="textTitle !== '车位信息管理' && textTitle !== '车辆信息管理'"
  ...
  <div style="width: 100%; justify-content: center; display: flex">
    <div class="headerStyleTable">
      <div style="display: flex">
        ...
        />
        <el-input
          v-model="inputSencond"
          :placeholder="inputPlodSencond"
          style="width: 120px; margin-left: 0px; height: 30px"
          v-if="inputPlodSencond"
        />
