...
let labelNameArr = ref([
  ...
  { label: "停车欠费", type: "input" },
  { label: "物业欠费", type: "input" },
]);
...
let rules = reactive({
  ...
  parkingArrearage: [{ required: true, message: "请填写停车欠费金额", trigger: "blur" }],
  wuyeArrearage: [{ required: true, message: "请填写物业欠费金额", trigger: "blur" }],
});
let form1;
let formFilter;
