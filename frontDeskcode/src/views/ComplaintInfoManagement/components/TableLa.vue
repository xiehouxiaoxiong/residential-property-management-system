      ...
      >
        ...
        >
          <template #default="scope">
            <div
              v-if="
                item.propName !== 'complaintTime' && item.propName !== 'complaintStatus'
              "
            >
              {{ scope.row[item.propName] }}
            </div>
            <div v-if="item.propName === 'complaintTime'">
              {{ moment(scope.row.complaintTime).format(timeFormat) }}
            </div>
            <div v-if="item.propName === 'complaintStatus'">
              <div v-if="scope.row.complaintStatus === '待受理'" style="color: red">
                {{ scope.row.complaintStatus }}
              </div>

              <div v-if="scope.row.complaintStatus === '已受理'" style="color: green">
                {{ scope.row.complaintStatus }}
              </div>
            </div>
          </template>
