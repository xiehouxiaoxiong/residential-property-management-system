...
let emits = defineEmits(["openDetial", "deleteNoteId", "editId","resetPassword"]);
watchEffect(() => {
...
let statusColor={'待审核':'yellow','通过':'green','不通过':'red'}
let dialogVisibleConfirmReset = ref(false)
function resetPassword(index, data) {
   dialogVisibleConfirmReset.value=false
      ...
      >
        ...
        >
          <template #default="scope">
            <div
              v-if="
                item.propName !== 'avatar'
              "
            >
              {{ scope.row[item.propName] }}
            </div>
            <div v-if="item.propName === 'avatar'">            
                  <el-avatar
          ...
          <template #default="scope">
            <div style="color: #f3b805">
             <span
              ...
              >
              <span
                @click="dialogVisibleConfirmReset=true"
                style="color: #f3b805"
              >
                重置密码</span
              >
               <el-dialog
                  v-model="dialogVisibleConfirmReset"
                  title="是否重置密码"
                  width="400"
                ...
                >
                  ...
                  <template #footer>
                    <div class="dialog-footer">
                      <el-button @click="dialogVisibleConfirmReset = false">取消</el-button>
